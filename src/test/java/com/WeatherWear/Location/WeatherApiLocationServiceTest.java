...
class WeatherApiLocationServiceTest{

    private WeatherApiLocationService weatherApiLocationService;

    @BeforeEach
    void setup(){
        weatherApiLocationService = new WeatherApiLocationService();
    }
    ...
    void GetLocationReturnLocationWhenApiIsSuccessful() throws Exception{
        ...
        weatherApiLocationService.setHttpClient(mockClient);

        ObjectMapper mockMapper = mock(ObjectMapper.class);
        weatherApiLocationService.setMapper(mockMapper);
        ...
        //Exercise
        LocationResult res = weatherApiLocationService.getLocation();
