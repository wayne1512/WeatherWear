...
class FutureRecommendationServiceTest{

    RecommendationService recommendationService;

    @BeforeEach
    void setup(){
        recommendationService = new FutureRecommendationService();
    }
    ...
    void RecommendRainShouldRecommendUmbrellaWhenRainIs1mm() throws Exception{
        ...
        assertEquals("It will be raining so you do need an umbrella.\n", text);
    }
    ...
    void RecommendRainShouldNotRecommendUmbrellaWhenRainIs0mm() throws Exception{
        ...
        assertEquals("It will not be raining so you don't need an umbrella.\n", text);
    }
